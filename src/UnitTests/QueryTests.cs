...
public class QueryTests
{
    ...
    private const string _message =
        ...
        PID|1|Patient12345|12345^^^MIE&1.2.840.114398.1.100&ISO^MR||MOUSE^MINNIE^S||19240101|F|||123 MOUSEHOLE LN^^FORT WAYNE^IN^46808|||||||||||||||||||
    ...
    [InlineData("MSH.1", "|")] // field separator, bit of a special case, and means the indexing for other MSH's fields is off by one
    [InlineData("MSH.2", "^~\\&")] // Encoding Chars, also a special case
    [InlineData("MSH.5", "ReceivingApp")]
    ...
    [InlineData("PID.2", "Patient12345")] // Patient Id
